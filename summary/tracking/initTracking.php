<?php
    	...
    	$sql = 'SELECT pt.tracking_no,pt.order_product_tracking_id,pt.order_product_id,pt.width,pt.height,pt.length,pt.m3,pt.weight,pt.rate,pt.rateweight,pt.ratem3,pt.type,pt.remark as ptremark,pt.uid,pt.received_amount,pt.last_edit_date,pt.statusid as pstat,pt.producttypeid,pt.masterflg,pt.amount,pt.remark,o.order_id
    		,op.backshop_quantity,op.quantity,op.unitprice,op.order_shipping_cn_cost,op.order_product_totalprice,op.order_status,op.backshop_price,op.backshop_shipping_cost,op.backshop_total_price,op.return_baht,op.return_status
    		,o.order_number,o.remark as oremark, o.order_rate,o.date_order_paid,o.customer_id,op.quantity,o.tracking_no as oTracking,o.taobao
